...
import * as querystring from 'intern/dojo/node!querystring';
import * as httpProxy from 'intern/dojo/node!http-proxy';
import * as formidable from 'intern/dojo/node!formidable';
